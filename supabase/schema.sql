...
ALTER TABLE public.shops ADD COLUMN IF NOT EXISTS mp_payment_id TEXT;
ALTER TABLE public.shops ADD COLUMN IF NOT EXISTS mp_preapproval_id TEXT;
...
-- COMPATIBILIDAD DE COLUMNA RESERVED_STOCK Y CONDICIÓN (NUEVO/USADO) EN INVENTARIO
ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS reserved_stock INT DEFAULT 0;
ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS condition TEXT DEFAULT 'nuevo';
ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS condition_grade TEXT;
ALTER TABLE public.inventory ADD COLUMN IF NOT EXISTS source_notes TEXT;
